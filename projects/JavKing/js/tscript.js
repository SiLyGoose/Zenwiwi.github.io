...
function createHeaderNavUserLogin(event) {
	...
	httpGet("https://discord.com/api/v10/users/@me", function (response) {
		...
		login.click(function (event) {
			event.preventDefault();
			location.href = "https://discord.com/api/oauth2/authorize?client_id=676672920625610753&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fguild-member-login-callback&response_type=code&scope=identify%20guilds&state=home.html";
			return false;
		});
	});
}
